...
public class BackendApplication {
    ...
    public void fillDatabase(){
        ...
        if(organizationRepository.findAll().size() == 0){
            organizationRepository.save(new Organization("supporters@wwf.be", password, "+3223400920", "Belgium", "1000", "Emile Jacqmainlaan 90", Role.ORGANIZATION,"WWF", "BE0408656248", "BE0408656248", "Sinds de oprichting in 1966", "Onze slogan ‘Together Possible!’", "WWF zet zich in", "+3223400920", "supporters@wwf.be", "https://adfinitas-statics-cdn.s3.eu-west-3.amazonaws.com/wwf/defisc-20/logo.jpg"));
            organizationRepository.save(new Organization("info@bkks.be", password, "+3211192819", "Belgium", "3800", "Diesterstraat 67A bus 001", Role.ORGANIZATION,"Belgisch KinderKanker Steunfonds", "BE0835627680", "0835627680", "Het Belgisch Kinder Kanker", "Het Belgisch Kinder", "Zelfsn dan financiële steun om deze moeilijke", "+3223400920", "supporters@wwf.be", "https://belgischkinderkankersteunfonds.be/wp-content/uploads/2020/02/cropped-logo-bkks-1.png"));
            organizationRepository.save(new Organization("welkom@bzn.be", password, "032012210", "Belgium", "2100", "Herentalsebaan 74", Role.ORGANIZATION,"Bond Zonder Naam", "BE0469514642", "BE0469514642", "De Bond zonder Naam (BZN) is een Vlaamse", "Bond zonder Naam schreef voor de", "Bond zonder Naam wil zoveel", "+3223400920", "supporters@wwf.be", "https://www.bzn.be/graphics/default-socialmedia.jpg"));
            organizationRepository.save(new Organization("maite@think-pink.be", password, "+32475406602", "Belgium", "1070", "Researchdreef 12", Role.ORGANIZATION,"Think Pink", "0810893274", "BE0810893274", "Think Pink is de nationale", "ondersteunen van zorg- en nazorgprojecten", "Borstkankanker steunen.", "+32475406602", "info@think-pink.be", "https://upload.wikimedia.org/wikipedia/commons/4/4b/Logo_think-pink.jpg"));
            organizationRepository.save(new Organization("info@damiaanactie.be", password, "+3224225911", "Belgium", "1081", "Leopold II-laan 263", Role.ORGANIZATION,"Damiaanactie", "0406694670", "BE05000000007575", "Damiaanactie is een Belgische medische non-profitorganisatie die zich inzet voor mensen met lepra, tuberculose en andere ziektes die vooral de kwetsbaarste bevolkingsgroepen treffen.", "Om lepra, tbc", "Bij Damiaanactie", "+3224225911", "info@damiaanactie.be", "https://damiaanactie.be/wp-content/uploads/2019/10/RGB-LOGO-DA-NL-transparant.png"));
            organizationRepository.save(new Organization("info@rodekruis.be", password, "+3215443322", "Belgium", "2800", "Motstraat 40", Role.ORGANIZATION,"Rode Kruis Vlaanderen", "2154897956", "BE0455024129", "Wij zijn", "Hulp", "Bij een ramp ", "+3215443322", "info@rodekruis.be", "https://www.rodekruis.be/img/logo.svg?1557833551"));
            organizationRepository.save(new Organization("elision@gmail.com", password, "+011771725", "Belgium", "3500", "Kempische Steenweg 311, Verdieping 5", Role.ADMIN,"Elision", "0406694870", "BE0884167272", "", "", "", "+011771725", "elision@gmail.com", "https://pbs.twimg.com/ext_tw_video_thumb/1229311494317277186/pu/img/8I5awCeVJQnLTiwL?format=jpg&name=large"));
