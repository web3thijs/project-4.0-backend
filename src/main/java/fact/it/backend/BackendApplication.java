...
public class BackendApplication {
    ...
    public void fillDatabase(){
        ...
        if(organizationRepository.findAll().size() == 0){
            organizationRepository.save(new Organization("supporters@wwf.be", password, "+32023400922", "Belgium", "1000", "Emile Jacqmainlaan 90", Role.ORGANIZATION,"WWF", "0123384623", "BE0408656248", "Sinds de oprichting in 1966", "Onze slogan ‘Together Possible!’", "WWF zet zich in", "+32023400922", "supporters@wwf.be", "https://adfinitas-statics-cdn.s3.eu-west-3.amazonaws.com/wwf/defisc-20/logo.jpg"));
            organizationRepository.save(new Organization("info@bkks.be", password, "+32011192819", "Belgium", "3800", "Diesterstraat 67A bus 001", Role.ORGANIZATION,"Belgisch KinderKanker Steunfonds", "0123321123", "BE0835627680", "Het Belgisch Kinder Kanker", "Het Belgisch Kinder", "Zelfsn dan financiële steun om deze moeilijke", "0479695051", "supporters@wwf.be", "https://belgischkinderkankersteunfonds.be/wp-content/uploads/2020/02/cropped-logo-bkks-1.png"));
            organizationRepository.save(new Organization("welkom@bzn.be", password, "+32011192820", "Belgium", "2100", "Herentalsebaan 74", Role.ORGANIZATION,"Bond Zonder Naam", "0123321623", "BE0469514642", "De Bond zonder Naam (BZN) is een Vlaamse", "Bond zonder Naam schreef voor de", "Bond zonder Naam wil zoveel", "+32479875051", "supporters@wwf.be", "https://www.bzn.be/graphics/default-socialmedia.jpg"));
            organizationRepository.save(new Organization("maite@think-pink.be", password, "+32475406602", "Belgium", "1070", "Researchdreef 12", Role.ORGANIZATION,"Think Pink", "0183321123", "BE0810893274", "Think Pink is de nationale", "ondersteunen van zorg- en nazorgprojecten", "Borstkankanker steunen.", "+32479675051", "info@think-pink.be", "https://upload.wikimedia.org/wikipedia/commons/4/4b/Logo_think-pink.jpg"));
            organizationRepository.save(new Organization("info@damiaanactie.be", password, "+32024225911", "Belgium", "1081", "Leopold II-laan 263", Role.ORGANIZATION,"Damiaanactie", "1123321123", "BE0406694670", "Damiaanactie is een Belgische medische non-profitorganisatie die zich inzet voor mensen met lepra, tuberculose en andere ziektes die vooral de kwetsbaarste bevolkingsgroepen treffen.", "Om lepra, tbc", "Bij Damiaanactie", "+32024225911", "info@damiaanactie.be", "https://damiaanactie.be/wp-content/uploads/2019/10/RGB-LOGO-DA-NL-transparant.png"));
            organizationRepository.save(new Organization("info@rodekruis.be", password, "+32154433228", "Belgium", "2800", "Motstraat 40", Role.ORGANIZATION,"Rode Kruis Vlaanderen", "1122321123", "BE0455024129", "Wij zijn", "Hulp", "Bij een ramp ", "+32015443322", "info@rodekruis.be", "https://www.rodekruis.be/img/logo.svg?1557833551"));
