...
public class BackendApplication {
    ...
    public void fillDatabase(){
        ...
        if(productRepository.findAll().size() == 0){
            ...
            productRepository.save(new Product("Run for Think Pink T-shirt heren (wit)", "Net zoals bij elke sport, hoort ook bij het lopen een juiste outfit. Vertegenwoordig met dit T-shirt Think Pink op elk evenement of draag hem tijdens het trainen.", 9.99, true, Arrays.asList("https://www.think-pink.be/Portals/0/dtxArt/blok-afbeelding/bestand/20190820Think-Pink-2019Jeroen-Willems102-2_medium_1ba503c4-ce81-4f84-abbe-c5f02cef0356.jpg", "https://www.think-pink.be/Portals/0/dtxArt/blok-galerij/afbeelding/bestand/image_groot_ac0905cd-8657-4133-b05f-703e783572ba.png"), categoryRepository.findCategoryById(4), organizationRepository.findOrganizationById(10)));
            productRepository.save(new Product("Run for Think Pink T-shirt dames (roze)", "Net zoals bij elke sport, hoort ook bij het lopen een juiste outfit. Vertegenwoordig met dit T-shirt Think Pink op elk evenement of draag hem tijdens het trainen.", 9.99, true, Arrays.asList("https://www.think-pink.be/Portals/0/dtxArt/blok-afbeelding/bestand/6932E44F-510E-4C52-B60D-27AA69CD83A4_medium_6262025e-4c7e-468e-a0a2-2cb0237d0050.jpg"), categoryRepository.findCategoryById(5), organizationRepository.findOrganizationById(10)));
            productRepository.save(new Product("Drinkbus Think Pink","Deze leuke Think Pink-drinkbus zorgt voor de nodige verfrissing tijdens het sporten", 4.99, true, Arrays.asList("https://www.think-pink.be/Portals/0/dtxArt/blok-galerij/afbeelding/bestand/Drinkbus1_groot_3918fe9e-785f-4dd5-a652-071148ed6146.jpg", "https://www.think-pink.be/Portals/0/dtxArt/blok-galerij/afbeelding/bestand/DSC1350groot6936867c-357f-4227-890b-58c5_groot_3dd61d86-f996-49ab-ac4a-6be2443b20a5.jpeg"), categoryRepository.findCategoryById(7), organizationRepository.findOrganizationById(10)));
            productRepository.save(new Product("Geurkaars Bond zonder Naam", "Geurkaars ter ondersteuning van de Bond zonder Naam", 8.00, true, Arrays.asList("https://i.imgur.com/9uiTrqz.png"), categoryRepository.findCategoryById(9), organizationRepository.findOrganizationById(9)));
            productRepository.save(new Product("Geurstokjes Bond zonder Naam", "Geurstokjes ter ondersteuning van de Bond zonder Naam",  5.00,  true, Arrays.asList("https://i.imgur.com/fW2Jkm2.png"),categoryRepository.findCategoryById(9), organizationRepository.findOrganizationById(9)));
            productRepository.save(new Product("Sojakaars Bond zonder Naam", "Sojakaars ter ondersteuning van de Bond zonder Naam", 10.00, true, Arrays.asList("https://i.imgur.com/aOWdepM.png"),categoryRepository.findCategoryById(9), organizationRepository.findOrganizationById(9)));
            productRepository.save(new Product("3 stylo's Belgisch KinderKanker Fonds", "3 pennen met het logo van het Belgisch KinderKanker Fonds.", 6, true, Arrays.asList("https://www.online-fanshop.be/wp-content/uploads/2020/11/stylo-bkks.png"), categoryRepository.findCategoryById(3),organizationRepository.findOrganizationById(8)));
            productRepository.save(new Product("Mondmasker Belgisch KinderKanker Fonds", "Mondmasker met het logo van het Belgisch KinderKanker Fonds.",  8.25, true, Arrays.asList("https://www.online-fanshop.be/wp-content/uploads/2020/11/mondmasker-BKKS.png"), categoryRepository.findCategoryById(8), organizationRepository.findOrganizationById(8)));
            productRepository.save(new Product("Stanno Pride T-Shirt", "Dit stretchy sportshirt, onderdeel van de Stanno Pride collectie, is voorzien van het logo van BKKS.", 24.99,  true, Arrays.asList("https://i.imgur.com/dLA2Rab.png"), categoryRepository.findCategoryById(4), organizationRepository.findOrganizationById(8)));
        }
