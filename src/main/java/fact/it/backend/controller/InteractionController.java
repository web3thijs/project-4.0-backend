...
public class InteractionController {
    ...
    public void fillDB(){
        if(interactionRepository.count() == 0){
            Review review1 = new Review("61e7e7512ddca07d1ddc79a1", 4, "Good", "");
            Review review2 = new Review("61e7e7512ddca07d1ddc79a2", 4.5, "Nice product", "I liked it.");
            ...
            interactionRepository.save(new Interaction("61e802077497a90f52ca03d4", product1, customer1,review1, 26));
            interactionRepository.save(new Interaction("61e802077497a90f52ca03d8", product2, customer2, review2, 23));
        }
