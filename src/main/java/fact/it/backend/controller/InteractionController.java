...
public class InteractionController {
    ...
    public void fillDB(){
        if(interactionRepository.count() == 0){
            ...
            interactionRepository.save(new Interaction("61e802077497a90f52ca03d4", product1, new ObjectId().toString(), new ObjectId().toString(), 26));
            interactionRepository.save(new Interaction("61e802077497a90f52ca03d8", product2, new ObjectId().toString(), new ObjectId().toString(), 23));
        }
